/**
 * @fileoverview TIDAL API service using Monochrome proxy instances
...
/**
 * Gets stream URL using instance
 * @async
 * @function getStreamUrl
 * @param {number} id - Track ID
 * @param {string} [quality='LOW'] - Quality (LOW, HIGH, LOSSLESS, HI_RES_LOSSLESS)
...
async function getStreamUrl(id, quality = 'LOSSLESS') {
  ...
  if (!info) throw new Error('No stream info found')
...
/**
 * Gets stream info with quality metadata
 * @async
