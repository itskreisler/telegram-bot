...
- Envía un enlace de tipo *reel de instagram* y te descargo el video
Ej: https://www.instagram.com/reel/CtCS04vPgg6/?igshid=MTc4MmM1YmI2Ng==

- Envía un enlace de tipo *foto de twitter* y te descargo la foto
